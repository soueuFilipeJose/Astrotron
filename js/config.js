const GAME_CONFIG = Object.freeze({
  ...
  asteroid: {
    // Asteroides colidíveis: 7% maiores que a versão anterior.
    large: 51,
    medium: 33,
    small: 20,
    minSplitRadius: 25
  ...
  debris: {
    phaseOneAmount: 22,
    // Mais lento: aproximadamente 30% mais devagar que a versão anterior.
    phaseOneDriftSpeed: 24,
    // Fundo: detritos 3x maiores que a versão anterior.
    backgroundScale: 3
  },
  ...
  progression: {
    firstXpGoal: 130,
    xpGrowth: 1.3,
    // A barra de XP sobe 30% mais devagar.
